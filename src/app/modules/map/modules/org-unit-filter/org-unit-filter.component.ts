...
export class OrgUnitFilterComponent implements OnInit, OnDestroy {
  ...
  constructor(private orgunitService: OrgUnitService, private changeDetector: ChangeDetectorRef) {
  ...
  ngOnInit() {
    ...
    this.subscription = this.orgunitService.getOrgunitLevelsInformation().subscribe((data: any) => {
                  ...
                  (items: any) => {
                    ...
                    for (const active_orgunit of this.orgUnitModel.selectedOrgUnits) {
                      this.activateNode(
                        active_orgunit.id,
                        this.orgtree,
                        active_orgunit.id === this.orgUnitModel.userOrgUnits.id
                      );
                    }
