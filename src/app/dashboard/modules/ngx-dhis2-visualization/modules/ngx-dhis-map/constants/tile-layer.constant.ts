...
export const TILE_LAYERS: { [id: string]: TileLayer } = {
  osmLight: {
    name: 'osmLight',
    type: 'tileLayer',
    label: 'OSM Light',
...
const DEFAULT_BASE_LAYER = 'osmLight';

export const getTileLayer = (tileLayerId = DEFAULT_BASE_LAYER): TileLayer => TILE_LAYERS[tileLayerId];
