...
export const getVisualizationLoadingState = createSelector(
  visualizationState,
  state => state.loading
);

export const getDashboardGroupedVisualizationObjects = createSelector(
  visualizationState,
  getAllDashboards,
  (visualization: VisualizationState, dashboards: Dashboard[]) => {
    // return _.filter(_.map(dashboards || [], (dashboards: any) => {
    //   return dashboards ? {
    //     id: dashboards.id,
...
export const getCurrentDashboardVisualizationObjects = createSelector(
  ...
  (visualization: VisualizationState, currentDashboard: Dashboard) =>
    visualization.currentVisualization || !currentDashboard
      ? []
      : _.filter(
...
export const getCurrentVisualizationObject = createSelector(
  ...
  (visualization: VisualizationState) =>
    _.find(visualization.visualizationObjects, [
      "id",
